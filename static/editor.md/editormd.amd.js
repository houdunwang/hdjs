...
;(function(factory) {
	...
	else if (typeof define === "function")  // AMD/CMD/Sea.js
	{
        ...
        {
            var cmModePath  = window.hdjs.base+"/dist/static/editor.md/lib/codemirror/mode/";
            var cmAddonPath = window.hdjs.base+"/dist/static/editor.md/lib/codemirror/addon/";

            var codeMirrorModules = [
                "jquery", "marked", "prettify",
                "katex", "raphael", "underscore", "flowchart",  "jqueryflowchart",  "sequenceDiagram",
                window.hdjs.base+"/dist/static/editor.md/lib/codemirror/lib/codemirror",
                cmModePath + "css/css",
